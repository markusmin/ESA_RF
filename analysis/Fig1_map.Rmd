...
salish_sea_map <- ggplot(usa_spdf_fort, aes(x = long, y = lat, group = group))+
  ...
  # end segments
  scale_fill_manual(values = c("gray90", "gray90", "gray90", "gray90")) +
  ...
  annotate("segment", x = -122.84, y = 47.68, xend = -123.18, yend = 47.68) + # Hood Canal
  annotate("text", x = -123.2, y = 47.68, label = "Hood Canal", size = 3, hjust = 1) + # Hood Canal
  annotate("text", x = -126, y = 49.9, label = "Vancouver Island", size = 3, angle = -25) + # Vancouver Island
  annotate("text", x = -126.153, y = 50.474, label = "Johnstone Strait", size = 3, hjust = 1) + # Johnstone Strait
  annotate("text", x = -127.3, y = 50.75, label = "Queen\nCharlotte\nStrait", size = 3) + # Queen Charlotte Strait
  annotate("text", x = -123.88, y = 49.33, label = "Strait of Georgia", size = 3, angle = -12) + # Strait of Georgia
  annotate("text", x = -124.16, y = 48.35, label = "Strait of Juan de Fuca", size = 3, angle = -16) + # Strait of Juan de Fuca
