...
ggplot(rec_43_64_effort_stats, aes(x = year, y = fisherman_days)) +
  geom_point()
...
rec_43_64_effort_stats %>% 
  ...
  mutate(source = ifelse(is.na(fisherman_days), "interpolated", "WDFW estimate")) -> rec_43_64_effort_stats
