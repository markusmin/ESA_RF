...
```{r separate_HC_join_USDPS_94_02}
ye_rec_SPS_94_02 %>% 
...
Again, we only have catch broken down by North Sound and South Sound without any estimates of regional differences (importantly, Hood Canal is not separated from South Sound). We are assuming that 12% of catch in South Sound is from Hood Canal.
  - See Palsson 1987 for more detailed catch statistics - might be able to break down areas of catch better
...
```{r separate_HC_join_USDPS_70_93}
ye_rec_SPS_70_93 %>% 
