...
## Recreational Data: 1938-1941 | Overview
...
- While reports are available for 1942, I only used the reports for 1938-1941 because of issues with reporting in 1942
  - "A considerable drop in the statistical return from Puget Sound resort owners was noted during 1942" - caused by attempt to change reporting system. Average number of boathouses reporting dropped from >60 in 1940-41 to 13 in 1942.
...
## Recreational Data: 1938-1941 | Estimating Total Effort
...
## Recreational Data: 1938-1941 | Catch Scenarios
<div style="font-size: 14pt;">
- Yelloweye:
  - High catch scenario: In years where "red snapper" is listed, all of the other rockfish catch is prorated to red snapper, based on the mean proportion of total rockfishes that are "red snapper" from the years 1940-1941, and is added to the "red snapper" catch. In years where no red snapper is listed (1938 and 1939), prorate catch based on mean proportion of total rockfishes that are "red snapper" from the years 1940-41 * 2.
  ...
  - Low catch scenario: In years where "red snapper" is listed, it is the only yelloweye catch. In years where no red snapper is listed (1938 and 1939), prorate catch based on mean proportion of total rockfishes that are "red snapper" from the years 1940-41 * 0.5. 
</div>
  
## Recreational Data: 1938-1941 | Catch Scenarios
- Bocaccio:
    - High catch scenario: 0.5% of the rockfish catch is bocaccio
    - Medium catch scenario: 0.25% of the rockfish catch is bocaccio
    - Low catch scenario: No bocaccio were caught (0%)
    
## Recreational Data: 1942-1965 | Overview
...
## Recreational Data: 1942-1965 | Effort
...
## Recreational Data: 1942-1965 | Where were boathouses located?
<center>
...
## Recreational Data: 1942-1965 | 1957 map of boathouses used to apportion effort by region
...
```
## Recreational Data: 1942-1965 | Estimating bottomfish catches
...
## Recreational Data: 1942-1965 | Catch scenarios
